...
from components.Openai.src.utils.response import build_object_detection_response
from components.Openai.src.utils.prompt_builders import prepare_object_detection_prompt
from components.Openai.src.utils.openai_client import call_openai

class OpenaiObjectDetection(Component):
    """
    Object detection returning normalized bounding boxes using OpenAI Vision models.
    """
    ...
    def run(self):
        try:
            ...
            prompt_data = prepare_object_detection_prompt(self.classes, img.value)
            ...
            try:
                ...
                self.parsed_classes = data.get("detections", data)
