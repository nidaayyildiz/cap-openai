...
from components.Openai.src.utils.response import build_ocr_response
from components.Openai.src.utils.prompt_builders import prepare_ocr_prompt
from components.Openai.src.utils.openai_client import call_openai

class OpenaiOcr(Component):
    """
