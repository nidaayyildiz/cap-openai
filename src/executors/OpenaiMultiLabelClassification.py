...
from components.Openai.src.utils.response import build_multi_label_classification_response
from components.Openai.src.utils.prompt_builders import prepare_multilabel_prompt
from components.Openai.src.utils.openai_client import call_openai

class OpenaiMultiLabelClassification(Component):
    """
