...
from capsules.Openai.src.utils.prompt_builders import prepare_multilabel_prompt
...
class OpenaiMultiLabelClassification(Capsule):
    """
    Multi-label image classification using OpenAI Vision models.
    """
    def __init__(self, request, bootstrap):
        ...
        # ReasoningEffort: model'e göre farklı parametre adı kullanılır
    ...
    def run(self):
        try:
            ...
            prompt_data = prepare_multilabel_prompt(self.classes, img.value)
            ...
            try:
                ...
                self.parsed_classes = data.get("predicted_classes", data)
