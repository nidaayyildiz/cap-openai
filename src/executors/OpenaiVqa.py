...
from capsules.Openai.src.utils.response import build_vqa_response
from capsules.Openai.src.utils.prompt_builders import prepare_vqa_prompt
from capsules.Openai.src.utils.openai_client import call_openai, call_azure_openai, call_novavision_openai


class OpenaiVqa(Capsule):
    """
