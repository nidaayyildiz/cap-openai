...
from components.Openai.src.utils.response import build_vqa_response
from components.Openai.src.utils.prompt_builders import prepare_vqa_prompt
from components.Openai.src.utils.openai_client import call_openai

class OpenaiVqa(Component):
    """
    Answers questions about an image using OpenAI Vision models.
    """
    ...
    def run(self):
        try:
            ...
            prompt_data = prepare_vqa_prompt(self.prompt, img.value)
        ...
        return build_vqa_response(context=self)
