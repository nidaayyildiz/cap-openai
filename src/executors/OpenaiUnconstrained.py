...
from components.Openai.src.utils.response import build_unconstrained_response
from components.Openai.src.utils.prompt_builders import prepare_unconstrained_prompt
from components.Openai.src.utils.openai_client import call_openai

class OpenaiUnconstrained(Component):
    """
    Arbitrary prompt execution with image using OpenAI Vision models.
    """
    ...
    def run(self):
        try:
            ...
            prompt_data = prepare_unconstrained_prompt(self.prompt, img.value)
        ...
        return build_unconstrained_response(context=self)
