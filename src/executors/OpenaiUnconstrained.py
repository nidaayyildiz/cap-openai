...
from capsules.Openai.src.utils.response import build_unconstrained_response
from capsules.Openai.src.utils.prompt_builders import prepare_unconstrained_prompt
from capsules.Openai.src.utils.openai_client import call_openai, call_azure_openai, call_novavision_openai


class OpenaiUnconstrained(Capsule):
    """
